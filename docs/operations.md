...
`plume-sim-risk-flow` is centered on simulations work in C#. The technical target is: Create a C# reference implementation for risk workflows, centered on diagnostic reporting, negative fixtures, and human-readable error snapshots.
...
The score is deterministic. The current threshold is 155. Risk has a penalty of 5, latency has a penalty of 4, and weight contributes a bonus of 6.
